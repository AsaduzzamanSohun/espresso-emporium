            ...
            <div className=" h-[776px] bg-[url('https://i.imgur.com/4MgIrCf.jpg')]">
                <div className="max-w-[1440px] md:p-10 mx-auto flex flex-col-reverse md:flex-row justify-between items-center">
                    <nav className="mt-20 text-center md:text-start">
                        ...
                        <div className="space-y-2 md:space-y-8 md:mt-8">
                            <img className="w-[45px] md:w-[75px] mx-auto md:mx-0" src="https://i.imgur.com/YeGYiVO.png" alt="" />

                            <h2 className="text-xl md:text-[45px] font-rancho dark drop-shadow-md">Espresso Emporium</h2>

                            <p className="font-raleway dark text-xs md:text-lg md:leading-loose px-8 md:px-0 max-w-[663px]">
                                Always ready to be your friend. Come & Contact with us to share your memorable moments, to share with your best companion.
                            </p>
                        </div>

                        <div className="flex gap-4 text-[16px] md:text-[40px] dark mt-4 md:mt-8 justify-center md:justify-start">
                        ...
                        <h2 className="md:text-[45px] font-rancho dark drop-shadow-md mt-6">Get in Touch</h2>

                        <div className="md:space-y-4 mt-4 md:mt-8 text-center mx-auto flex flex-col items-center md:items-start">
                            <div className="flex gap-4 md:text-[20px] dark text-xs">
                    ...
                    <nav className="mt-12 md:mt-36">
                        <h2 className="md:text-[45px] font-rancho dark drop-shadow-md mb-4 text-center md:text-start">Get in Touch</h2>
                        <form className="flex flex-col gap-4 max-w-[503px] md:w-[503px]" action="">
                            ...
                            <input className="submit text-sm md:text-lg max-w-[150px] mx-auto md:mx-0" type="submit" value="Send Message" />
                        </form>
                    </nav>
                </div>
            </div>
