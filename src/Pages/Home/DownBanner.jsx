...
const DownBanner = () => {
    return (
        <div className="bg-[#ECEAE3]" >
            <div className="max-w-[1440px] mx-auto py-12 flex flex-col md:flex-row items-center justify-between gap-4 font-raleway">
                <div className="space-y-3 text-center md:text-start px-16 py-4 md:p-0">
                    ...
                    <h3 className="text-4xl font-rancho dark">Awesome Aroma</h3>
                    <p className="darker">
                ...
                <div className="space-y-3 text-center md:text-start px-12 py-4 md:p-0">
                    ...
                    <h3 className="text-4xl font-rancho dark">High Quality</h3>
                    <p className="darker">
                ...
                <div className="space-y-3 text-center md:text-start px-12 py-4 md:p-0">
                    ...
                    <h3 className="text-4xl font-rancho dark">Pure Grades</h3>
                    <p className="darker">
                ...
                <div className="space-y-3 text-center md:text-start px-12 py-4 md:p-0">
                    ...
                    <h3 className="text-4xl font-rancho dark">Proper Roasting</h3>
                    <p className="darker">
